...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        cornerList = tuple(self.corners)

        return startPosition, cornerList
            ...
            if not hitsWall:
                ...
                for corner in state[1]:
                    if corner != newPosition:
                        newCorners += (corner, )
                nextSuccessor = (newPosition, newCorners), action, 1
...
def cornersHeuristic(state, problem):
    ...
    while cornersLeft:
        ...
        for corners in cornersLeft:
            cost = util.manhattanDistance(currentPosition, corners)
            if cost < minCost:
                minCost = cost
                minCorner = corners
        ...
        for corner in cornersLeft:
            if corner != minCorner:
                updateCorners.append(corner)
        cornersLeft = tuple(updateCorners)
